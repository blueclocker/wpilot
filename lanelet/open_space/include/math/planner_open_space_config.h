 ...
 * @LastEditTime: 2023-02-23 16:58:16
 * @LastEditors: wpbit
 * @Description: 
...
struct WarmStartConfig {
  ...
  double phi_grid_resolution = 0.05;//0.05
  u_int64_t next_node_num = 10;//10
  double step_size = 0.5;
  double traj_forward_penalty = 1.0;//0
  double traj_back_penalty = 1.5;//0
  double traj_gear_switch_penalty = 10.0;//10
  double traj_steer_penalty = 1.5;//100
  double traj_steer_change_penalty = 2.0;//10
