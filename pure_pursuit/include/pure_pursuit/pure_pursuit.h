...
namespace vec_control
{
  ...
  private:
    ...
    lgsvl_msgs::VehicleControlData lgsvl_msg_;

    ros::Publisher control_pub_;
    ros::Publisher l_point_pub_;
    ros::Publisher current_speed_pub_;
    ros::Publisher lgsvl_pub_;
    ...
    void path_clk_(const visualization_msgs::MarkerArray::ConstPtr &msg);
    void control_loop_();
